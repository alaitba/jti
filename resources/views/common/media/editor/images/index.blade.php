...
<div class="controls shadow" >
    ...
    <form action="{{route('admin.media.editor.upload')}}" method="post" id="editorForm">
        <input type="file" name="images[]" class="form-control input-file" multiple="multiple" accept="image/*">
    </form>
</div>

<div class="galley-content" style="margin-top: 20px; max-height: 400px; overflow: scroll;">
    @include('backend.common.media.editor.images.images')
</div>