...
class SmsService
{
    ...
    public function sendSms($legal_age)
    {
        ...
        if ($inProd && !$this->codeType == self::TEST) {
            try {
                $disclaimer = '«Cіздің бір реттік құпиясөзіңіз – ' . $this->code . '. Осы құпиясөзді беру арқылы сіз «Джей
                Ти Ай Қазақстан» ЖШС-ға ақпарат, өнімдер және басқа мүлік алуға, сондай-ақ
                жеке деректеріңізді жинауға және өңдеуге келісіміңізді бересіз. Келісімнің
                толық мәтіні сілтеме бойынша берілген: ххххххххххххххххххх.
                Ваш одноразовый пароль – ' . $this->code . '. Передавая данный пароль, Вы даёте ТОО
                «Джей Ти Ай Казахстан» своё согласие на получение информации, продукции
                и иного имущества, а также на сбор, обработку своих персональных данных.
