...
class SmsService
{
    ...
    public function sendSms($legal_age)
    {
        ...
        if ($inProd && !$this->codeType == self::TEST) {
            try {
                $disclaimer = 'Ваш одноразовый пароль: ' . $this->code . '. Передавая пароль, Вы даёте ТОО «Джей Ти Ай Казахстан» согласие на получение информации, продукции и иного имущества, а также на сбор, обработку своих персональных данных. Полный текст согласия: http://terms.jti.kz:8020/?d=D002';
